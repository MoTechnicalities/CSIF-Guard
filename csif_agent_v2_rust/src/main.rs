...
fn complex_to_text(value: ComplexValue) -> String {
    ...
    if im.abs() < 1e-12 {
        ...
        format!("{}{}{}i", format_number(re), sign, format_number(im))
    }
}
    ...
    match parsed {
        ParsedMathInput::Scalar(ast) => {
            ...
            Ok(json!({
                ...
                "result_latex": format!("{} = {}", latex_expr, complex_to_text(result)),
                "deterministic": true,
...
fn build_success_envelope(
    ...
    EvaluationEnvelope {
        ...
        consistency: ConsistencyReport {
            ...
            math_logic_alignment: AlignmentStatus::Aligned,
